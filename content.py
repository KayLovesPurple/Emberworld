...
import journal   # noqa: F401 -- no names used directly; imported for its own
...
# same way cat.py/chicken.py register their own verbs -- write/read are
# journal.py's, the same way again.
FREE_VERBS.update({"look", "l", "examine", "x", "inventory", "i", "actions", "save", "map"})
