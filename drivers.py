...
from content import build_world, ensure_shelf, ensure_cairn, ensure_riverbank, ensure_charm_string, ensure_chicken, ensure_pot, ensure_fox, ensure_cat_corner, VERBS, FREE_VERBS, HEARTH_LOW_FUEL, LAMP_LOW_FUEL, _day_stamp, _crop_in, _statue_reachable
...
_REFUSAL_MARKERS = (
    ...
    "write what?", "name it what?", "eat what?", "no wood",
)
